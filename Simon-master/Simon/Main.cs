...
namespace Simon
{
    public partial class Main : Form
    {
        ...
        /*
GameState 1 is set upon start
GameState 2 is used when we complete a round
GameState 3 is used to reset the game
GameState 4 means that the game is active and you are playing
*/
